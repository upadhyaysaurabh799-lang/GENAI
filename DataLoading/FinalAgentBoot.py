...
class FinalAgentBoot:

    def __init__(self):

        # load chanks
        self.LOAD_PATH = Path("../data/processed/chunks.pkl")
        ...
        self.chat_history = [
         ...
         4. Never say you don't know for your own identity.
         5.If the user asks you anything that is not related
           to orders or Amazon, then answer it too using NLP 
         """
        )
]
